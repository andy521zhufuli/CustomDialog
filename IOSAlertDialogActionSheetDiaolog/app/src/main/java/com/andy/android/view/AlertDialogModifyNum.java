...
public class AlertDialogModifyNum
{
    ...
    private TextView    cart_single_product_et_num;//数量
    ...
    public AlertDialogModifyNum builder() {
        ...
        cart_single_product_et_num = (TextView) view.findViewById(R.id.cart_single_product_et_num);
        //设置商品数量
        ...
        cart_single_product_num_reduce.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(context, "jiaoshao", Toast.LENGTH_LONG).show();
            }
        });
        //商品数量添加anniu
